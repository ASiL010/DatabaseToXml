...
namespace DatabaseToXml
{
    public partial class Form1 : Form
    {
        ...
        #region SQLvaribles
        private readonly string connectionString = "Data Source=DESKTOP-69S6Q42\\SQLEXPRESS;Initial Catalog=OguzDTO;Integrated Security=True";
        ...
        private void KaydetBaslaTread()
        {
            while (true)
            {
                ...
                try
                {
                    ...
                    XElement[] a = new XElement[5];
                    for (int i = 0; i < a.Length; i++)
                    {
                        a[i] = new XElement("TRANSACTION");
                        a[i].Add(new XElement("TYPE", "A"),
                             new XElement("MASTER_CODE", "A"),
                             new XElement("QUANTITY", "A"),
                             new XElement("PRICE", "A"),
                ...
                string sorgu="Select Ad from Oturum";
